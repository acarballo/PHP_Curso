...
class models_dataGatewayMysql implements models_dataGatewayInterface {
	...
	function readUsers(){
		...
		try{
			...
			$query = "SELECT a.iduser,a.name,a.email,a.password,a.direccion,a.descripcion,c.gender,b.city,a.pets,'sports',a.photo ";
